...
<!-- Chart -->
<?php
$chartRevenue = "SELECT SUM(total_amount) AS totalAmount FROM homedecor_invoice GROUP BY MONTH(created)";
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row">
                    <a href="#" data-toggle="collapse" data-target="#collapseChart">
                        <h6 class="m-0 font-weight-bold tet-primary">Sales Chart</h6>
                    </a>
                </div>
                <div class="card-body collapse show" id="collapseChart">
                    <div class="row my-2 ">
                        <div class="col-lg-12">
