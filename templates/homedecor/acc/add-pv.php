...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO homedecor_pv (staffName, pvNum, payTo, accNum, accBank, description, amount, category, created, modified) VALUES ('$staffName', '$pvNum', '$payTo', '$sanitizeAccNum', '$accBank', '$description', '$amount', '$category', '$created', '$modified')";
                    ...
                    <div class="card-body">
                        <div class="row my-2 clearfix">
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="pvNum" id="" class="form-control" value="PV2021/00/0000">
                            </div>
                        </div>
                        <div class="row my-2 clearfix">
                            <div class="col-lg-6">
