...
// Get the data first
$id = $_GET['id'];
$sqlCash = "SELECT * FROM homedecor_cashin WHERE id = '$id'";
$resCash = mysqli_query($conn, $sqlCash);
...
$pdf->MultiCell(90, 10, 'Cash In Voucher', 0, 'L', 0, 0);
$pdf->MultiCell(90, 10, $rowCash['cashNum'], 0, 'R', 0, 0);
$pdf->Ln();
...
$pdf->Cell(100, 10, $rowCash['payFrom']);
$pdf->Ln();
...
$pdf->Cell(10, 10, ':');
$pdf->setFont('Helvetica', 'B', 11);
$pdf->Cell(100, 10, $rowCash['accNum']);
$pdf->Ln();
...
$pdf->Cell(10, 10, ':');
$pdf->setFont('Helvetica', 'B', 11);
$pdf->Cell(100, 10, $rowCash['accBank']);
$pdf->Ln();
$pdf->Ln();
...
$pdf->Cell(10, 10, ':');
$pdf->setFont('Helvetica', 'B', 11);
$pdf->Cell(100, 10, $rowCash['created']);
$pdf->Ln();
...
$pdf->Cell(10, 10, ':');
$pdf->setFont('Helvetica', 'B', 11);
$pdf->Cell(100, 10, $rowCash['staffName']);
$pdf->Ln();
...
// Result
$pdf->Output($rowCash['cashNum'] . '.pdf');
