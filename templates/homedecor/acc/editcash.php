...
$select = "SELECT * FROM homedecor_cashin";
$res = mysqli_query($conn, $select);
$rowCash = mysqli_fetch_assoc($res);

// Explode the stuff
$descriptions = explode(',', $rowCash['description']);
$categories = explode(',', $rowCash['category']);
$amounts = explode(',', $rowCash['amount']);
...
if (isset($_POST['submit'])) {
    ...
    $update = "UPDATE homedecor_cashin SET cashNum = '$cashNum', accBank = '$accBank', description = '$description', amount = '$amount', category = '$category', modified = '$modified'";
                    ...
                    <div class="card-body">
                        <div class="row my-2 clearfix">
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="cashNum" id="" class="form-control" value="<?= $rowCash['cashNum']; ?>">
                            </div>
                        </div>
                        <div class="row my-2 clearfix">
                            <div class="col-lg-6">
                                <label for="">Payment From</label>
                                <input type="text" name="payFrom" id="" class="form-control" value="<?= $rowCash['payFrom']; ?>">
                                <input type="text" name="staffName" id="" class="form-control d-none" value="<?= $row['fName']; ?>" readonly>
                            </div>
                            <div class="col-lg-3">
                                <label for="">Account Number</label>
                                <input type="text" name="accNum" id="" class="form-control" value="<?= $rowCash['accNum']; ?>">
                            </div>
                            <div class="col-lg-3">
...
<script>
    ...
    $(document).ready(function() {
        $(".add-row").click(function() {
            ...
            // Create table rows
            var markup = "<tr><td class='align-middle text-center'><input type='checkbox' name='record'></td><td class='align-middle text-left'><input type='text' name='description[]' value='" + description + "' class='border-0 text-left form-control'/></td><td><input type='text' name='category[]' value='" + category + "' class='border-0 text-center form-control'/></td><td><input name='amount[]' class='text-center align-middle form-control border-0' value='" + amount.toFixed(2) + "' /></td></tr>";
