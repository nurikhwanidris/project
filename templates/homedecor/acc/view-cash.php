...
<?php
// Get info
$cashNum = $_GET['cashNum'];

// Get info from PV table
$sql = "SELECT * FROM homedecor_cashin WHERE cashNum = '$cashNum'";
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-10 col-xl-10 justify-content-start">
                                ...
                                <h3 class="font-weight-bold text-uppercase">Cash In Voucher</h3>
                            </div>
                            <div class="col-lg-2 col-xl-2 align-self-end mb-1 text-right">
                                <span class="font-weight-bold pvNum"><?= $rowPV['cashNum']; ?></span>
                            </div>
                        </div>
                        <div class="row mb-0">
                            <div class="col-lg-12 col-xl-12 mb-0 misc">
                                <div class="form-group row">
                                    <label for="staticPayTo" class="col-sm-2 col-form-label">Payable From</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-8">
                                        <span class="text-capitalize font-weight-bold"><?= $rowPV['payFrom']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
